...
import EdsonJr21.bytebank.domain.conta.ContaService;
import EdsonJr21.bytebank.domain.conta.DadosAberturaConta;
...
public class BytebankApplication {
    ...
    private static void realizarTransferencia() {
        ...
        service.realizaTransferencia(numeroDaContaOrigem, numeroDaContaDestino, valor);
